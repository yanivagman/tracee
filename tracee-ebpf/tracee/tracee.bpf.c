...
#define UDP_SENDMSG                 1020
#define UDP_DISCONNECT              1021
#define UDP_DESTROY_SOCK            1022
#define UDPV6_DESTROY_SOCK          1023
#define TCP_CLOSE_EVENT             1024
#define TCP_DISCONNECT              1025
#define TCP_V4_DESTROY_SOCK         1026
#define TCP_ABORT                   1027
#define SECURITY_SOCKET_SHUTDOWN    1028
...
int BPF_KPROBE(trace_tcp_disconnect)
{
    if (!should_trace())
        return 0;
    ...
    context_t context = init_and_save_context(ctx, submit_p, TCP_DISCONNECT, 1 /*argnum*/, 0 /*ret*/);
...
int BPF_KPROBE(trace_tcp_v4_destroy_sock)
{
    if (!should_trace())
        return 0;
    ...
    context_t context = init_and_save_context(ctx, submit_p, TCP_V4_DESTROY_SOCK, 1 /*argnum*/, 0 /*ret*/);
...
int BPF_KPROBE(trace_tcp_abort)
{
    if (!should_trace())
        return 0;
    ...
    context_t context = init_and_save_context(ctx, submit_p, TCP_ABORT, 1 /*argnum*/, 0 /*ret*/);
