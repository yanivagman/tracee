...
func BenchmarkRSSEstimate(b *testing.B) {
	...
	fmt.Println()
	fmt.Println("NOTE: Compare heap-MB between WithInterning and WithoutInterning.")
	fmt.Println("The interned version should use significantly less heap memory for string backing arrays.")
}
